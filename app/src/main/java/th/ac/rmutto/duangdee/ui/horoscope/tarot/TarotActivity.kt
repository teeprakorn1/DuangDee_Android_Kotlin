...
class TarotActivity : AppCompatActivity() {
    ...
    private var decodeUsersID : String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        decodeUsersID = decrypt(usersID.toString(), encryption.getKeyFromPreferences())
    ...
    private fun dialogPredict() {
        ...
        if (cardImageFile != "null") {
            val imageCard = dialogView.findViewById<ImageView>(R.id.imageCard)
            val url = getString(R.string.url_server) + cardImageFile.toString()
        ...
        btAccept.setOnClickListener {
            dialogAcceptCard(randomNumbers.toString())
        }
    ...
    private fun dialogAcceptCard(cardID: String) {
        ...
        yesBtn.setOnClickListener {
            val playCardStatus = addPlayCard(decodeUsersID.toString(),cardID)
            if (playCardStatus){
                val intent = Intent(this, MainActivity::class.java)
                startActivity(intent)
            }else{
    ...
    private fun showCard(cardID : String){
        val url = getString(R.string.url_server) + getString(R.string.api_get_card) + cardID
    ...
    private fun getCount() : String {
        val url = getString(R.string.url_server) + getString(R.string.api_get_count_card)
        val okHttpClient = OkHttpClient()
        val request: Request = Request.Builder()
            .url(url)
            .get()
    ...
    private fun addPlayCard( userID : String ,cardID : String) : Boolean{
        val url = getString(R.string.url_server) + getString(R.string.api_playcard)
        val okHttpClient = OkHttpClient()
